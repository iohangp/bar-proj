		...
		<script src="<?php echo JS?>switchery.min.js"></script>
		<script src="<?php echo JS?>maskmoney.js"></script>
		<script src="<?php echo JS?>select2.full.min.js"></script>
		<script src="<?php echo JS?>funcoesGerais.js"></script>
		<script src="<?php echo JS?>jquery.inputmask.bundle.min.js"></script>
		...
		<script src="<?php echo JS?>jquery.flot.orderBars.js"></script>
		...
		<?php if(getParam(0)==""){?>
			<script src="<?php echo JS?>jquery.vmap.min.js"></script>
			<script src="<?php echo JS?>jquery.vmap.brazil.js"></script>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				var handleDataTableButtons = function() {
					if ($("#datatable-frete").length) {
						$("#datatable-frete").DataTable({
							dom: "Bfrtip",
							buttons: [
							/*{
								extend: "copy",
